            ...
            <div class="card-header-modern">
                <div class="d-flex gap-2">
                    <div class="input-group" style="width: 250px;">
                        ...
                        <input type="text" class="form-control bg-light border-start-0" placeholder="Tìm kiếm booking...">
                    </div>
                    <button class="btn btn-light border"><i class="bi bi-funnel"></i> Lọc</button>
                </div>
                <div>
